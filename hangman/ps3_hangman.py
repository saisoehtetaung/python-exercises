...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    numOfSectWord=len(secretWord)
    print("I'm thinking of a word that is",numOfSectWord,"letters long.")
    print("     ----------------------------    ")
